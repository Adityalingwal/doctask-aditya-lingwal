...
- HTML→DOCX: HTTP 200, valid OOXML (36KB, real `word/document.xml`). Files at `documentation/product-test-files/export-test.docx`.
- HTML→PDF: valid PDF 1.4, 1 page (23KB). `documentation/product-test-files/export-test.pdf`.
...
Source: `documentation/product-test-files/fidelity-test-master.docx` — a 22-page fictional Master Services Agreement built (by a background agent) with footnotes, endnotes, comments, tracked changes, 5 tables, image, headers/footers, equation, hyperlinks, landscape + 2-column sections.
...
- Local files: `documentation/product-test-files/mcp-sow-export.docx`, `mcp-upload-src.html/.b64`.
