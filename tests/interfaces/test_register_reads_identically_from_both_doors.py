...
# The locked API surface: seven endpoints, no run-level export route beside
# them. The register is the project's, read live — never a run's copy.
LOCKED_ROUTES = {
    ("POST", "/projects"),
    ("GET", "/projects"),
    ("POST", "/runs"),
...
def test_the_api_offers_exactly_the_seven_locked_routes() -> None:
