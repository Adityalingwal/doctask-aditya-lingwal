# Helpline AI — Meeting Notes

**Date:** 2 July 2026
**Attendees:** BrightCart Operations Lead, Software Provider Delivery Owner
...
three different tools and nobody can find anything when a customer calls
back.

They also asked for a weekly report showing how many calls and chats came in
and how many were actually resolved, so the ops lead can report numbers
upward without pulling everything together by hand each week.

Support has to work in Hindi and English — a good share of BrightCart's
customers write in Hindi, and the bot should understand and answer in
whichever language the customer uses.
