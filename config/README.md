...
| File | Holds |
|---|---|
| `rules.yaml` | The rules the system checks documents and the register against. A default set ships with the repo so a fresh clone runs; point at your own file to replace it. |
